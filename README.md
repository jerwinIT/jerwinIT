...
Full-stack web developer with a strong foundation across the entire **SDLC** — from system design and development to testing, documentation, and deployment. I specialize in building web applications that integrate **geospatial data**, and I move comfortably between writing clean code, automating tests, and shipping production-ready systems.
...
I build web applications that make **spatial data useful** — combining PostGIS for geospatial queries with Leaflet.js for dynamic, interactive maps. If data has a location, I can put it on a map and turn it into something actionable.

## 🤖 QA & Automation

Experienced across the full SDLC: writing and executing **manual test cases**, building **automated test suites** with Pytest and Playwright, producing user manuals, and designing system documentation — architecture diagrams, DFDs, and more.

## ⚡ AI-Assisted Development

I integrate AI tools into my workflow deliberately — not to replace thinking, but to move faster and sharpen my output.
